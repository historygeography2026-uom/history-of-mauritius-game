  ...
  if (error) {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen p-4">
        {isNotLoggedIn ? (
          <Card className="kid-card p-8 text-center max-w-md w-full border-2 border-primary/30">
            <div className="text-6xl mb-3 animate-bounce">🔒</div>
            <h2 className="kid-heading text-2xl mb-2">Login Required!</h2>
            <p className="text-slate-600 mb-6 text-sm leading-relaxed">
              You need to{" "}
              <span className="font-bold text-primary">register or log in</span> to
              attempt questions. Create a free account to start playing and track your
              progress!
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button
                className="kid-btn bg-gradient-to-r from-primary via-purple-500 to-secondary hover:shadow-lg hover:shadow-primary/50 text-white font-bold px-6 py-3"
                onClick={() => router.push("/auth/sign-up")}
              >
                🚀 Register for Free
              </Button>
              <Button
                className="kid-btn bg-gradient-to-r from-secondary via-secondary/80 to-secondary hover:shadow-lg hover:shadow-secondary/50 text-white font-bold px-6 py-3"
            ...
            <button
              className="mt-5 text-xs text-slate-400 hover:text-primary underline transition-colors"
              onClick={() => router.push("/")}
            >
              ← Back to Home
            </button>
          ...
          <Card className="p-8 text-center max-w-md w-full border-red-500">
