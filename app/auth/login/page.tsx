              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="grid gap-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link href="/auth/forgot-password" className="text-xs text-primary underline underline-offset-4 hover:text-primary/80">
                      Forgot password?
                    </Link>
                  </div>
                  <Input
                ...
                <Button type="submit" className="kid-btn w-full bg-gradient-to-r from-primary to-blue-600 text-white py-3 text-lg" disabled={isLoading}>
