// app/g4/play/page.tsx — Grade 4 Play orchestrator: dispatches to Fable question screens
"use client"
...
function G4PlayContent() {
  ...
  const handlePracticeAgain = async () => {
    ...
    try {
      ...
      window.location.href = `/g4/play?session=${data.session_id}`
    } catch {
      router.push("/g4")
    }
  }
...
export default function G4PlayPage() {
  return (
    <Suspense fallback={
